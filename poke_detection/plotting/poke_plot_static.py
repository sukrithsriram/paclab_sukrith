...
class PlotWindow(QWidget):
    def __init__(self, pi_widget):
        ...
        self.plot_interval = 1600  # Total duration of the plot in seconds
    ...
    def update_plot(self):
        ...
        current_time = time.time()
        # Remove data points that are outside the plot interval
        while self.timestamps and current_time - self.timestamps[0] > self.plot_interval:
