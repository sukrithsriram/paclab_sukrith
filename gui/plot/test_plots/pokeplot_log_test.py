...
# Set the directory path for saving files
d = datetime.now()
SAVE_DIRECTORY = "/home/mouse/dev/paclab_sukrith/logs/"

# Configure logging to save log files in the specified directory
LOG_FILE_PATH = os.path.join(SAVE_DIRECTORY, f"exp_{d}.log")
...
class PiSignal(QGraphicsEllipseItem):
    ...
    def set_color(self, color):
        if color == "green":
            ...
            logging.warning("Invalid color:", color)
    ...
    def update_Pi(self):
        ...
        try:
            ...
            if 1 <= poked_port <= self.total_ports: 
                ...
                logging.info("Sequence:", self.poked_port_numbers) 
                ...
                logging.warning("Invalid Pi number received:", poked_port)
        except ValueError:
            logging.info("Connected to Raspberry Pi:", message)
